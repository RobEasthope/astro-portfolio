...
export function WorkSection() {
  return (
    <Box as="section" id="work" className="mx-auto w-full max-w-40">
      <Box as="section" id="work" className="mx-auto max-w-prose">
      ...
      <Box
        as="ul"
        className="mx-auto grid grid-cols-1 gap-x-1 gap-y-0.5 sm:grid-cols-2 md:grid-cols-3 md:gap-x-2 md:gap-y-1 lg:grid-cols-3"
      >
